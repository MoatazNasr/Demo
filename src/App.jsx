...
import Quizzes from "./components/Quzzies/Quizzes";
...
function App() {
  ...
  return (
    <>
      <video src={gif?.url} loop={true} autoPlay={true} muted className="background-video"/>
      <BrowserRouter>
        <main className="main">
          ...
          <section className="content">
            <Routes>
              ...
              <Route path="/Classes/:chapterName/videos" element={<Videos />} />
              <Route
              ...
              <Route
                ...
                element={<Quizzes />}
              />
              <Route path="/Classes/:chapterName/3D%20Models" element={<Models />} />
